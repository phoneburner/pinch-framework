...
final class EnvironmentTest extends TestCase
{
    ...
    public function environmentCanGetValuesFromTheEnvironmentAndServer(): void
    {
        ...
        $sut = new Environment(Context::Test, BuildStage::Staging, '', $server, $env);
        ...
        $sut = new Environment(Context::Test, BuildStage::Staging, '', $server, $env);
        self::assertSame('production', $sut->server('SERVER_DUMMY_00', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('staging-value', $sut->server('SERVER_DUMMY_01', 'default-value', 'development-value', 'staging-value'));
        self::assertFalse($sut->server('SERVER_DUMMY_02', 'default-value', 'development-value', 'staging-value'));
        self::assertTrue($sut->server('SERVER_DUMMY_03', 'default-value', 'development-value', 'staging-value'));
        self::assertTrue($sut->server('SERVER_DUMMY_04', 'default-value', 'development-value', 'staging-value'));
        self::assertFalse($sut->server('SERVER_DUMMY_05', 'default-value', 'development-value', 'staging-value'));
        self::assertTrue($sut->server('SERVER_DUMMY_06', 'default-value', 'development-value', 'staging-value'));
        self::assertFalse($sut->server('SERVER_DUMMY_07', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(0, $sut->server('SERVER_DUMMY_08', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(1, $sut->server('SERVER_DUMMY_09', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(0.0, $sut->server('SERVER_DUMMY_10', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(1.0, $sut->server('SERVER_DUMMY_11', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(0.1, $sut->server('SERVER_DUMMY_12', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(1.1, $sut->server('SERVER_DUMMY_13', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('string-value', $sut->server('SERVER_DUMMY_14', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('staging-value', $sut->server('SERVER_DUMMY_15', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('staging-value', $sut->server('SERVER_DUMMY_16', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('production', $sut->env('ENV_DUMMY_00', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('staging-value', $sut->env('ENV_DUMMY_01', 'default-value', 'development-value', 'staging-value'));
        self::assertFalse($sut->env('ENV_DUMMY_02', 'default-value', 'development-value', 'staging-value'));
        self::assertTrue($sut->env('ENV_DUMMY_03', 'default-value', 'development-value', 'staging-value'));
        self::assertTrue($sut->env('ENV_DUMMY_04', 'default-value', 'development-value', 'staging-value'));
        self::assertFalse($sut->env('ENV_DUMMY_05', 'default-value', 'development-value', 'staging-value'));
        self::assertTrue($sut->env('ENV_DUMMY_06', 'default-value', 'development-value', 'staging-value'));
        self::assertFalse($sut->env('ENV_DUMMY_07', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(0, $sut->env('ENV_DUMMY_08', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(1, $sut->env('ENV_DUMMY_09', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(0.0, $sut->env('ENV_DUMMY_10', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(1.0, $sut->env('ENV_DUMMY_11', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(0.1, $sut->env('ENV_DUMMY_12', 'default-value', 'development-value', 'staging-value'));
        self::assertSame(1.1, $sut->env('ENV_DUMMY_13', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('string-value', $sut->env('ENV_DUMMY_14', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('staging-value', $sut->env('ENV_DUMMY_15', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('staging-value', $sut->env('ENV_DUMMY_16', 'default-value', 'development-value', 'staging-value'));

        $sut = new Environment(Context::Test, BuildStage::Development, '', $server, $env);
        self::assertSame('production', $sut->server('SERVER_DUMMY_00', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('development-value', $sut->server('SERVER_DUMMY_01', 'default-value', 'development-value', 'staging-value'));
        self::assertFalse($sut->server('SERVER_DUMMY_02', 'default-value', 'development-value', 'staging-value'));
        self::assertTrue($sut->server('SERVER_DUMMY_03', 'default-value', 'development-value', 'staging-value'));
        self::assertTrue($sut->server('SERVER_DUMMY_04', 'default-value', 'development-value', 'staging-value'));
        self::assertFalse($sut->server('SERVER_DUMMY_05', 'default-value', 'development-value', 'staging-value'));
        ...
        self::assertSame(1.1, $sut->server('SERVER_DUMMY_13', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('string-value', $sut->server('SERVER_DUMMY_14', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('development-value', $sut->server('SERVER_DUMMY_15', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('development-value', $sut->server('SERVER_DUMMY_16', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('production', $sut->env('ENV_DUMMY_00', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('development-value', $sut->env('ENV_DUMMY_01', 'default-value', 'development-value', 'staging-value'));
        self::assertFalse($sut->env('ENV_DUMMY_02', 'default-value', 'development-value', 'staging-value'));
        self::assertTrue($sut->env('ENV_DUMMY_03', 'default-value', 'development-value', 'staging-value'));
        self::assertTrue($sut->env('ENV_DUMMY_04', 'default-value', 'development-value', 'staging-value'));
        self::assertFalse($sut->env('ENV_DUMMY_05', 'default-value', 'development-value', 'staging-value'));
        ...
        self::assertSame(1.1, $sut->env('ENV_DUMMY_13', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('string-value', $sut->env('ENV_DUMMY_14', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('development-value', $sut->env('ENV_DUMMY_15', 'default-value', 'development-value', 'staging-value'));
        self::assertSame('development-value', $sut->env('ENV_DUMMY_16', 'default-value', 'development-value', 'staging-value'));
    }
}
