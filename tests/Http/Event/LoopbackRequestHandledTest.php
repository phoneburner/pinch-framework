...
final class LoopbackRequestHandledTest extends TestCase
{
    #[Test]
    public function constructorAcceptsValidRequestInterface(): void
    {
        ...
        $event = new LoopbackRequestHandled($request);
    ...
    public function getLogEntryReturnsCorrectLogEntryWithDebugLevel(): void
    {
        ...
        self::assertSame('Loopback Request Handled', $log_entry->message);
    }
    ...
    public function constructorWorksWithMultipleDifferentRequests(): void
    {
        ...
        $event_1 = new LoopbackRequestHandled($request_1);
        $event_2 = new LoopbackRequestHandled($request_2);
